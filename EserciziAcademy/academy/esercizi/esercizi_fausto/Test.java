package academy.esercizi.esercizi_fausto;
...
di parentesi la chiusura avviene nell ordine corretto: */// l ultima apeta prima chiusa ([]{}())
//  []{()}// la parentesi che si chiude deve stare o subio dopo oppure nel suo indice speculare
// se si sono tutte chiuse allora rifai il controllo sopra,// se una di un tipo e aperta e subito
// dopo chiusa allora va bene e rifai.
// devono essere pari dello stesso tipo  e appena c'è un
// tipo nuovo// devono esserci prima le aperte e poi le chiuse// devi chiuderle seguendo
// la stessa posizione in modo speculare
