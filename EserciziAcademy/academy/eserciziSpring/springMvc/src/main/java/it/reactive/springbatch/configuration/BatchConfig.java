...
*/
    @Bean("jobSetup")
    public Job jobSetup(JobRepository jobRepository, @Qualifier("transactionManagerTorneo") PlatformTransactionManager transactionManager,
                        ...
                        JpaPagingItemReader<GiocatoreEntity> reader2,
                        GiocatoriWriter writer2,
                        ItemProcessor<GiocatoreEntity, GiocatoreCSV> processor2
                        ) {
        return new JobBuilder("jobSetup", jobRepository)
                ...
                .next(csvStep(jobRepository, transactionManager, reader2, writer2, processor2))
...
*/
    ...
    public Step deleteAll(JobRepository jobRepository,
                          @Qualifier("transactionManagerTorneo") PlatformTransactionManager transactionManager,
    ...
    @Bean
    public Step dbSetup(JobRepository jobRepository, @Qualifier("transactionManagerTorneo")  PlatformTransactionManager transactionManager,
                        FlatFileItemReader<String> reader,
                        JpaItemWriter<Object> writer,
                        ItemProcessor<String, Object> itemProcessor) {
        return new StepBuilder("dbSetup", jobRepository)
                .<String, Object>chunk(10000, transactionManager)
                .reader(reader)
    ...
    @Bean
    public Step csvStep(JobRepository jobRepository,@Qualifier("transactionManagerTorneo")  PlatformTransactionManager transactionManager,
                        JpaPagingItemReader<GiocatoreEntity> reader,
                        GiocatoriWriter writer,
                        ItemProcessor<GiocatoreEntity, GiocatoreCSV> processor) {
