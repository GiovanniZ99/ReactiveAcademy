...
public class TorneoController {
    ...
    @PostMapping
    public ResponseEntity<Torneo> salvaTorneo(@Valid @RequestBody @ApiParam(value = "SquadraDTO", required = true) TorneoDTO torneoDTO) {
    ...
    public ResponseEntity<Torneo> iscrizioneSquadraAlTorneo(@PathVariable @ApiParam(value = "id torneo", required = true) @Min(0) @Max(9999) Long idTorneo, @PathVariable @ApiParam(value = "id squadra", required = true) @Min(0) @Max(9999) Long idSquadra) {
    ...
    @ApiOperation(value = "rimuovi una torneo")
    @DeleteMapping("/{id}")
    public ResponseEntity<Void> deleteTorneo(@PathVariable @ApiParam(value = "id torneo", required = true) @Min(0) @Max(9999) Long id) {
